...
from domains.regional_sales_analyzer.models import RegionalFilters
...
async def get_filter_options() -> Dict[str, Any]:
    ...
    try:
        from domains.regional_sales_analyzer.data_service import RegionalSalesAnalyzerDataService

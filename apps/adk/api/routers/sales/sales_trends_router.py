...
from domains.sales.sales_trends.processing_service import SalesTrendsProcessingService
from domains.sales.sales_trends.models import SalesTrendFilters
...
async def get_filter_options() -> Dict[str, Any]:
    ...
    try:
        from domains.sales.sales_trends.data_service import SalesTrendsDataService
        import asyncio

"""Anomaly detection database schema - Following ChurnSchema pattern"""

from database.base_schema import TableSchema, BaseSchema


class AnomalySchema(BaseSchema):
    """Schema for anomaly detection following the ChurnSchema pattern"""
    ...
    # Transaction schema with additional fields for anomaly detection
    ...
    # AR Detail schema for financial anomalies
    AR_DETAIL = TableSchema(
        table_name=TABLES['ar_detail'],
        alias=ALIASES['ar_detail'],
        columns={
            'customer_id': '"Customer Key"',
        ...
        refs={
            'customer_id': 'ar."Customer Key"',
            'document': 'ar."Document Number"',
            'date': 'ar."Posting Date"',
            'amount': 'ar."Open Amount"',
            'days_overdue': 'ar."Days Overdue"',
        },
        output_aliases={
            'customer_id': 'customer_id',

...
from adk.domains.transaction_patterns.data_service import TransactionPatternsDataService
from adk.domains.transaction_patterns.ml_predictor import TransactionPatternsPredictor
...
class TransactionPatternsService:
    ...
    def __init__(self):
        ...
        self.ml_predictor = TransactionPatternsPredictor()
    ...
    async def get_dashboard_summary(self, filters: Dict = {}) -> Dict:
        ...
        try:
            ...
            customers_task = self.data_service.get_customer_data(filters)
            transactions_task = self.data_service.get_transaction_data(filters)
            loyalty_task = self.data_service.get_loyalty_data(filters)

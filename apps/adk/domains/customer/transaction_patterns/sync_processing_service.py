"""Sync wrapper for TransactionPatternsService to support agent framework"""
...
class SyncTransactionPatternsService:
    """Sync wrapper that converts async TransactionPatternsService to sync for agent framework"""

    def __init__(self):
        self.async_service = TransactionPatternsService()
        self._loop = None

"""Sync wrapper for CustomerSegmentationService to support agent framework"""
...
class SyncCustomerSegmentationService:
    """Sync wrapper that converts async CustomerSegmentationService to sync for agent framework"""

    def __init__(self):
        self.async_service = CustomerSegmentationService()
        self._loop = None

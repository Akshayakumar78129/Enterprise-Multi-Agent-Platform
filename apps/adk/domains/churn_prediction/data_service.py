"""Churn prediction data service - Direct port from Express"""
...
class ChurnDataService:
    """Port of Express ChurnDataService"""

    def __init__(self):
        self.db = DatabaseConnection()
        self.schema = ChurnSchema()
        self.filter_engine = FilterEngine()

    async def get_customers(self, filters: Dict[str, Any] = {}) -> Dict:
        """Direct port of Express getCustomers

        Returns customer data with basic information
        """
        sql = f"""
        SELECT
    ...
    async def get_transactions(self, filters: Dict[str, Any] = {}) -> Dict:
        """Direct port of Express getTransactions

        Returns transaction data for customers
        """
        sql = f"""
        SELECT
    ...
    async def get_loyalty(self, filters: Dict[str, Any] = {}) -> Dict:
        """Direct port of Express getLoyalty

        Returns loyalty metrics for customers
        """
        sql = f"""
        SELECT

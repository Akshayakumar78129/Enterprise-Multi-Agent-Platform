"""Synchronous wrapper for warehouse analytics processing service"""

import asyncio
from typing import Dict, Any, List
from .processing_service import WarehouseAnalyticsProcessingService


class SyncWarehouseAnalyticsProcessingService:
    """Synchronous wrapper for warehouse analytics processing"""

    def __init__(self):
        self.async_service = WarehouseAnalyticsProcessingService()

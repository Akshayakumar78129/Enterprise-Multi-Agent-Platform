"""Sync wrapper for PurchaseFrequencyService to support agent framework"""
...
class SyncPurchaseFrequencyService:
    """Sync wrapper that converts async PurchaseFrequencyService to sync for agent framework"""

    def __init__(self):
        self.async_service = PurchaseFrequencyService()
        self._loop = None

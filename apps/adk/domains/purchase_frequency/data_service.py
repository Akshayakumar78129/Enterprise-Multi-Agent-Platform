"""
Purchase Frequency data service
...
class PurchaseFrequencyDataService:
    """Data service for Purchase Frequency"""
    ...
    async def get_purchase_frequency_data(self, filters: Dict[str, Any] = {}) -> Dict:
        """Get purchase frequency analysis data - matches web folder logic"""

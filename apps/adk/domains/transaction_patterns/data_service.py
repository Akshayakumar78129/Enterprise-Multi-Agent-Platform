"""
Transaction Patterns data service
...
class TransactionPatternsDataService:
    """Data service for Transaction Patterns"""

    def __init__(self):
        self.db = DatabaseConnection()
        self.schema = TransactionPatternsSchema()
    ...
    async def get_transaction_pattern_data(self, filters: Dict[str, Any] = {}) -> Dict:

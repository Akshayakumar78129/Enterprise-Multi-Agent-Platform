"""Synchronous wrapper for supplier performance processing service"""

import asyncio
from typing import Dict, Any, List
from .processing_service import SupplierPerformanceProcessingService


class SyncSupplierPerformanceProcessingService:
    """Synchronous wrapper for supplier performance processing"""

    def __init__(self):
        self.async_service = SupplierPerformanceProcessingService()

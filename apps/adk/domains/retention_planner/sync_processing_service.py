"""Sync wrapper for RetentionPlannerService to support agent framework"""
...
class SyncRetentionPlannerService:
    """Sync wrapper that converts async RetentionPlannerService to sync for agent framework"""

    def __init__(self):
        self.async_service = RetentionPlannerService()
        self._loop = None

"""Sync wrapper for EngagementClassifierService to support agent framework"""
...
class SyncEngagementClassifierService:
    """Sync wrapper that converts async EngagementClassifierService to sync for agent framework"""

    def __init__(self):
        self.async_service = EngagementClassifierService()
        self._loop = None

"""Sync wrapper for CustomerLtvService to support agent framework"""
...
class SyncCustomerLtvService:
    """Sync wrapper that converts async CustomerLtvService to sync for agent framework"""

    def __init__(self):
        self.async_service = CustomerLtvService()
        self._loop = None

...
from orchestration_agent.utils.customer_analytics_utils import (
...
def analyze_customer_behavior(
    ...
    try:
        # Set database path
        db_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "database", "customers.db")
        print(db_path)
        ...
        # Preprocess data
        processed_data = preprocess_behavioral_data(
            customer_data, 
            transaction_data,
            min_transactions
        )
        ...
        purchase_patterns = analyze_purchase_patterns(processed_data, time_period)
        logger.info("Completed purchase pattern analysis")
        
        # Calculate behavioral metrics
        behavioral_metrics = calculate_behavioral_metrics(processed_data, behavior_types)
        logger.info("Completed behavioral metrics calculation")
        
        # Generate visualizations if requested
        visualizations = {}
        if include_visualization:
            visualizations = visualize_behavior_patterns(processed_data, behavior_types)

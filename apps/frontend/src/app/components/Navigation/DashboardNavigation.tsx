  ...
  const navigationItems: NavigationItem[] = [
    ...
    },
    {
      ...
      children: [
        {
          name: 'Customer LTV',
          href: '/customer/customer-lifetime-value',
          icon: DollarSign,
          description: 'Lifetime value analysis',
        },
        {
          name: 'Anomaly Detection',
          href: '/customer/anomaly-detection',
          icon: ShieldAlert,
        ...
        },
        {
          ...
          href: '/customer/performance-deviation',
          icon: Activity,
        ...
        },
        {
          ...
          href: '/customer/purchase-frequency',
          icon: Clock,
        ...
        },
        {
          ...
          href: '/customer/transaction-patterns',
          icon: GitBranch,
        ...
        },
        {
          ...
          href: '/customer/engagement-classifier',
          icon: UserPlus,
        ...
        },
        {
          ...
          href: '/customer/retention-planner',
          icon: Scale,
      ...
      children: [
        {
          ...
          href: '/inventory/inventory-level',
          icon: Package,
        ...
        },
        {
          ...
          href: '/inventory/stock-optimization',
          icon: Settings2,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: '/finance/ar-aging-analysis',
          icon: Banknote,

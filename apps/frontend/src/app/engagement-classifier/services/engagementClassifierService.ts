...
class EngagementClassifierService {
  async getDashboardSummary(filters: Record<string, any> = {}) {
    const response = await fetch(`${API_BASE_URL}/engagement-classifier/summary`, {
      method: 'POST',
      headers: {
  ...
  async getEngagementAnalysis(filters: Record<string, any> = {}) {
    const response = await fetch(`${API_BASE_URL}/engagement-classifier/analysis`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async getClassifications(filters: Record<string, any> = {}) {
    const response = await fetch(`${API_BASE_URL}/engagement-classifier/classifications`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async exportData(filters: Record<string, any> = {}, format: 'csv' | 'json' = 'csv') {
    const response = await fetch(`${API_BASE_URL}/engagement-classifier/export`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },

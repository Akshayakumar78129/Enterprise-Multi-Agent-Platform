// Engagement Classifier Dashboard Page - Following churn pattern
"use client";
...
import {
  EngagementClassifierKPIs,
  EngagementClassifierCharts,
  EngagementClassifierInsights,
} from "./components";
...
export default function EngagementClassifierPage() {
  const { filters, setFilters, timeRange, setTimeRange, selectedPoints, selectionManager, customers, setCustomers } = useEngagementClassifierContext();
    ...
    <>
      ...
      <DashboardSection title="Key Metrics">
        {loading ? (
          ...
          <EngagementClassifierKPIs data={data} loading={loading} />
        )}
      </DashboardSection>

      {/* Main Analysis Section */}
      <div id="main-analysis" />
      <DashboardSection title="Engagement Classifier Analysis">
        <EngagementClassifierCharts
          data={chartData}
          loading={loading}

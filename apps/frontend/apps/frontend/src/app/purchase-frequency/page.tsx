// Purchase Frequency Dashboard Page - Following churn pattern
"use client";
...
import {
  ...
  PurchaseFrequencyCharts,
  PurchaseFrequencyInsights,
} from "./components";
...
export default function PurchaseFrequencyPage() {
  const { filters, setFilters, timeRange, setTimeRange, selectedPoints, selectionManager, customers, setCustomers } = usePurchaseFrequencyContext();
    ...
    <>
      ...
      <DashboardSection title="Key Metrics">
        {loading ? (
          ...
          <PurchaseFrequencyKPIs data={data} loading={loading} />
        )}
      </DashboardSection>

      {/* Main Analysis Section */}
      <div id="main-analysis" />
      <DashboardSection title="Purchase Frequency Analysis">
        <PurchaseFrequencyCharts
          data={chartData}
          loading={loading}

// Customer Segmentation Dashboard Page - Following churn pattern
"use client";
...
import {
  CustomerSegmentationKPIs,
  CustomerSegmentationCharts,
  CustomerSegmentationInsights,
} from "./components";
import { useCustomerSegmentationData } from "./hooks/useCustomerSegmentationData";
import { useCustomerSegmentationContext } from "./context";

export default function CustomerSegmentationPage() {
  const { filters, setFilters, timeRange, setTimeRange, selectedPoints, selectionManager, customers, setCustomers } = useCustomerSegmentationContext();
  ...
  const {
    ...
    metadata,
    ...chartData
  } = useCustomerSegmentationData(filters);
    ...
    <>
      ...
      <DashboardSection title="Key Metrics">
        {loading ? (
          ...
          <CustomerSegmentationKPIs data={data} loading={loading} />
        )}
      </DashboardSection>

      {/* Main Analysis Section */}
      <div id="main-analysis" />
      <DashboardSection title="Customer Segmentation Analysis">
        <CustomerSegmentationCharts
          data={chartData}
          loading={loading}

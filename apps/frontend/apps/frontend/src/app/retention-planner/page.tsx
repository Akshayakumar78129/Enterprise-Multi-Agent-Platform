// Retention Planner Dashboard Page - Following churn pattern
"use client";
...
import {
  RetentionPlannerKPIs,
  RetentionPlannerCharts,
  RetentionPlannerInsights,
} from "./components";
...
export default function RetentionPlannerPage() {
  const { filters, setFilters, timeRange, setTimeRange, selectedPoints, selectionManager, customers, setCustomers } = useRetentionPlannerContext();
    ...
    <>
      ...
      <DashboardSection title="Key Metrics">
        {loading ? (
          ...
          <RetentionPlannerKPIs data={data} loading={loading} />
        )}
      </DashboardSection>

      {/* Main Analysis Section */}
      <div id="main-analysis" />
      <DashboardSection title="Retention Planner Analysis">
        <RetentionPlannerCharts
          data={chartData}
          loading={loading}

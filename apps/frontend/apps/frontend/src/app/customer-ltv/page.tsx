// Customer Lifetime Value Dashboard Page - Following churn pattern
"use client";
...
export default function CustomerLtvPage() {
  const { filters, setFilters, timeRange, setTimeRange, selectedPoints, selectionManager, customers, setCustomers } = useCustomerLtvContext();
    ...
    <>
      ...
      <DashboardSection title="Key Metrics">
        {loading ? (
          ...
          <CustomerLtvKPIs data={data} loading={loading} />
        )}
      </DashboardSection>

      {/* Main Analysis Section */}
      <div id="main-analysis" />
      <DashboardSection title="Customer Lifetime Value Analysis">
        <CustomerLtvCharts
          data={chartData}
          loading={loading}

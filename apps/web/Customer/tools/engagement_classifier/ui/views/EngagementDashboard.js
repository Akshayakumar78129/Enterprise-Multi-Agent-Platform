...
const EngagementDashboard = () => {
  ...
  useEffect(() => {
    setChatContext({
      ...
      data: data ? {
        ...
        avgEngagementScore: data.kpis?.avgEngagementScore || 0,
        reengagementOpportunities: data.kpis?.reengagementOpportunities || 0,
        daysSinceActivity: data.kpis?.daysSinceActivity || 0
      } : null,
  ...
  return (
    <div className="engagement-dashboard">
      ...
      <div className="standard-card pyramid-glass-bg" style={{ 
        marginBottom: "var(--spacing-2xl)"
      }}>

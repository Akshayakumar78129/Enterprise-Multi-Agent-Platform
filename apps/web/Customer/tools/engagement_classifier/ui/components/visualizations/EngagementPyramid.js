...
const EngagementPyramid = ({ 
  ...
  const renderTier = (tierData) => {
    ...
    const isHigh = tierData.engagement_level === 'High';
    const isMedium = tierData.engagement_level === 'Medium';
    ...
    return (
      ...
      >
        ...
        <div style={{
          fontSize: '20px',
          marginBottom: isHigh ? '-4px' : '8px' // pull emoji slightly down for High tier
        }}>
          {config.icon}
        </div>
        ...
        <div style={{
          fontSize: '14px',
          color: '#f7f9fb',
          marginTop: isHigh ? '0px' : '4px', // nudge label slightly downward for High tier to center
          fontWeight: '500',
          fontFamily: 'Inter, sans-serif'
        }}>
          {config.label}
        ...
        <div style={{
          ...
          color: '#f7f9fb',
          opacity: 0.8,
          marginTop: isHigh ? '-8px' : isMedium ? '-3px' : '4px', // keep High at -8px; Medium tuned via 2px
          fontFamily: 'Inter, sans-serif'
        }}>

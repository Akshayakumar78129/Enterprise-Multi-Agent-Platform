...
import SalesPerformanceDashboard from '../ui/views/SalesPerformanceDashboard';
...
// This is needed for the SalesPerformanceDashboard to correctly infer AppDispatch type
export type AppDispatch = typeof store.dispatch;

/**
 * Sales Performance Analyzer Page
 *
 * A Next.js page that renders the Sales Performance Analyzer tool with AI features
 */

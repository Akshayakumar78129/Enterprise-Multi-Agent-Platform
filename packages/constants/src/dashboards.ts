...
export const DASHBOARDS: Dashboard[] = [
  ...
  },
  {
    ...
    domain: 'customer',
    description: 'Analyze customer purchase frequency patterns and intervals',
    icon: '🔄',
    features: ['kpi', 'filters', 'charts', 'table'],
    status: 'development',
  },
  ...
  // Inventory Domain Dashboards
  {
    ...
    path: '/inventory/inventory-level',
    domain: 'inventory',
  ...
  },
  {
    ...
    domain: 'inventory',
    description: 'Identify and manage slow-moving stock items with low turnover rates',
    icon: '🐌',
    features: ['kpi', 'filters', 'charts', 'table'],
    status: 'active',
  },
